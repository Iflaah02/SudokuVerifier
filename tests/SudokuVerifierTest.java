...
// An incorrect Sudoku string: 123456789912345678891234567789123456678912345567891234456789123345678912234567891
	...
	@Test
	public void testVerify_correctString_returnZero() throws Exception {
		//init
	...
	@Test
	public void testVerify_twoShortString_returnMinusOne() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
	...
	@Test
	public void testVerify_twoLongString_returnMinusOne() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
	...
	@Test
	public void testVerify_invalidCharactersString_returnMinusOne() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
	...
	@Test
	public void testVerify_duplicateCharactersInRowString_returnMinusThree() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
	...
	@Test
	public void testVerify_duplicateCharactersInColString_returnMinusFour() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
	...
	@Test
	public void testVerify_duplicateCharactersInGridString_returnMinusTwo() throws Exception {
		//init
		SudokuVerifier verifier = new SudokuVerifier();
